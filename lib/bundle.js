...
exports.MonitorMap = undefined;

var _index = __webpack_require__(6);

exports.MonitorMap = _index.MonitorMap; /**
                                         * Created by weibin.shao on 2018/9/29.
                                         * lib index.
                                         */
...
exports.MonitorMap = _index2.default;
...
var _monitorMap = __webpack_require__(16);
...
var schemeData = {
  ...
  children: [{
    ...
    scences: ['scence1', 'scence2'],
    children: ['model3', 'model2', 'model5', 'scence21', 'scence22', 'scence37', 'scence27', 'scence33']
  }, {
    id: 'scheme2',
    name: '方案2',
    type: 'scheme',
    models: ['model1', 'model2', 'model5'],
    scences: ['scence1', 'scence2', 'scence6'],
    children: ['model1', 'model2', 'model5', 'scence21', 'scence22', 'scence26', 'scence28', 'scence29', 'scence40']
  }, {
    id: 'scheme3',
    name: '方案3',
    type: 'scheme',
    models: ['model3', 'model4'],
    scences: ['scence2', 'scence5'],
    children: ['model3', 'model4', 'model1', 'scence22', 'scence25', 'scence33', 'scence36', 'scence39']
  }, {
    id: 'scheme4',
    name: '方案4',
    type: 'scheme',
    models: ['model1', 'model4'],
    scences: ['scence3', 'scence5'],
    children: ['model1', 'model4', 'model2', 'scence23', 'scence25', 'scence32', 'scence35', 'scence38']
  }, {
    id: 'scheme5',
    name: '方案5',
    type: 'scheme',
    models: ['model3', 'model5'],
    scences: ['scence4', 'scence6'],
    children: ['model3', 'model5', 'model1', 'scence24', 'scence26', 'scence31', 'scence34', 'scence37']
  }, {
    id: 'scheme6',
    name: '方案6',
    type: 'scheme',
    ...
    scences: ['scence2', 'scence5'],
    children: ['model2', 'model4', 'scence22', 'scence25', 'scence30', 'scence33', 'scence36']
  }]
};
...
var MonitorMap = function (_PureComponent) {
  _inherits(MonitorMap, _PureComponent);

  function MonitorMap(props) {
    _classCallCheck(this, MonitorMap);

    var _this = _possibleConstructorReturn(this, (MonitorMap.__proto__ || Object.getPrototypeOf(MonitorMap)).call(this, props));

    _this.map = null;
    return _this;
  }

  _createClass(MonitorMap, [{
    ...
    key: 'initMap',
    value: function initMap(data) {
      this.map = (0, _monitorMap.rendererMap)({
        data: data,
        options: {
          width: 1800,
          height: 1200
    ...
    value: function render() {
      return _react2.default.createElement('div', { id: 'monitorMap', className: _index2.default.monitorMap });
    }
  }]);
...
// module
exports.push([module.i, "#monitorMap {\n  width: 100%;\n  height: 100%;\n  display: flex;\n  overflow: auto;\n  background-color: black;\n}\n", ""]);
...
var _defs = __webpack_require__(17);

var _monitorMap = __webpack_require__(18);

var _monitorMap2 = _interopRequireDefault(_monitorMap);
...
function rendererMap(context) {
   ...
   * 坐标投影
   */
  var projection = function projection(x, y) {
    var angle = x * Math.PI / 180;
    return [y * Math.cos(angle), y * Math.sin(angle)];
  };

  // 模块间 link 计数, 用于计算模块间 link 圆弧半径
  var linkTotal = (_linkTotal = {}, _defineProperty(_linkTotal, moduleTypes.MODEL, 0), _defineProperty(_linkTotal, moduleTypes.SCENCE, 0), _linkTotal);

  /**
   * tooltip
   */
  var toolTip = d3.select('body').append('div').attr('id', 'tooltipContainer').style('opacity', 0);
  ...
  function init() {
    ...
    // 圆环半径参数
    ringRadius = (_ringRadius = {}, _defineProperty(_ringRadius, moduleTypes.MODEL, {
      inner: radius - 180,
      outer: radius,
      width: 180
    }), _defineProperty(_ringRadius, moduleTypes.SCHEME, {
      inner: radius - 320,
      outer: radius - 260,
      width: 60
    }), _defineProperty(_ringRadius, moduleTypes.SCENCE, {
      inner: radius - 460,
      outer: radius - 400,
      width: 60
    }), _ringRadius);
    ...
    // 坐标系: x-角度 y-半径
    cluster = (_cluster = {}, _defineProperty(_cluster, moduleTypes.MODEL, d3.cluster().size([360, radius - 430])), _defineProperty(_cluster, moduleTypes.SCHEME, d3.cluster().size([360, (radius - 290) * 2])), _defineProperty(_cluster, moduleTypes.SCENCE, d3.cluster().size([360, (radius - 60) * 2])), _cluster);
  }
  ...
  function coordConvert(root) {
    var convert = _defineProperty({}, moduleTypes.SCENCE, function (root) {
      // 数据扁平化
      var flatList = root.descendants();
    ...
    try {
      for (var _iterator = Object.entries(root)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        var _step$value = _slicedToArray(_step.value, 2),
            key = _step$value[0],
            value = _step$value[1];

        var convertFunc = convert[key];
        if (convertFunc) {
          convertFunc(value);
        }
      }
  ...
  function nodeFilter() {
    ...
    var filter = (_filter = {}, _defineProperty(_filter, moduleTypes.SCENCE, function (item) {
      return item.depth > 0;
    }), _defineProperty(_filter, moduleTypes.MODEL, function (item) {
      return item.depth > 0;
    }), _defineProperty(_filter, moduleTypes.SCHEME, function (item) {
  ...
  function linkFilter() {
    ...
    var filter = (_filter2 = {}, _defineProperty(_filter2, moduleTypes.SCENCE, function (item) {
      return item.depth > 1;
    }), _defineProperty(_filter2, moduleTypes.MODEL, function (item) {
      return item.depth > 1;
    }), _defineProperty(_filter2, moduleTypes.SCHEME, function (item) {
  ...
  function addLayers(selection) {
    var layers = ['link-layer', 'indirect-link', 'node-layer'];

    selection.selectAll('.layer').data(layers).enter().append('g').attr('class', function (d) {
      return 'layer ' + d;
    });
  }
  ...
  function draw(selection) {
    ...
    try {
      for (var _iterator2 = Object.entries(root)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
        var _step2$value = _slicedToArray(_step2.value, 2),
            key = _step2$value[0],
            value = _step2$value[1];

        var nodeData = value.descendants().filter(nodeFilter()[key]);
        var linkData = value.descendants().filter(linkFilter()[key]).map(function (d) {
          return _extends({}, d, {
            from: d,
            to: d.parent
          });
        ...
        var nodes = getNodes(selection.select('.node-layer'), nodeData, '.node.' + key).enter();

        var links = getNodes(selection.select('.link-layer'), linkData, '.link.' + key).enter();
    ...
    // 获取绘制模块间 link 对应的数据
    var indirectLinkData = root.scheme.descendants().filter(function (item) {
      return item.__parent__;
    }).reduce(function (nodeList, item) {
      return nodeList.concat(item.__parent__.map(function (parent) {
        return {
          from: item,
          to: parent
        };
    ...
    var indirectGroups = getNodes(selection.select('.indirect-link'), indirectLinkData, 'path.scheme.indirect').enter();
  ...
  function drawCircleRing(selection) {
    // 圆环
    var circleRing = function circleRing(innerRadius, outerRadius) {
      return d3.arc().innerRadius(innerRadius).outerRadius(outerRadius).startAngle(0).endAngle(2 * Math.PI);
    };

    // 第一级圆环-模型
    selection.append('svg:path').attr('class', 'arc').attr('d', circleRing(ringRadius[moduleTypes.MODEL].inner, ringRadius[moduleTypes.MODEL].outer));

    // 第二级圆环-方案
    selection.append('svg:path').attr('class', 'arc2').attr('d', circleRing(ringRadius[moduleTypes.SCHEME].inner, ringRadius[moduleTypes.SCHEME].outer));

    // 第三级圆环-场景
    selection.append('svg:path').attr('class', 'arc3').attr('d', circleRing(ringRadius[moduleTypes.SCENCE].inner, ringRadius[moduleTypes.SCENCE].outer));
  }
  ...
  function drawNodes(nodes, className) {
    var node = nodes.append('g').attr('class', 'node ' + className).attr('transform', function (d) {
  ...
  function drawLinks(links, className) {
    var link = links.append('path').attr('class', 'link ' + className).attr('d', function (d) {
      // 三次贝塞尔曲线
      var from = d.from,
          to = d.to;

      return 'M' + projection(from.x, from.y) + ('C' + projection(from.x, (from.y + to.y) / 2) + ' ') + (projection(to.x, (from.y + to.y) / 2) + ' ') + ('' + projection(to.x, to.y));
    });
  ...
  function drawIndirectLinks(links, className) {
    var getPath = function getPath(d) {
      ...
      var padding = 10;
      var schemeRing = ringRadius[moduleTypes.SCHEME];
      var moduleType = from.data.type || from.parent.data.type;
      var space = (80 - 2 * padding) / linkTotal[moduleType];
      var variable = schemeRing.width / 2 + padding;
      var nodeIndex = from.data.index[to.data.id];
      // 圆弧半径
      var radius = from.data.type === moduleTypes.MODEL ? to.y - variable - space * nodeIndex : to.y + variable + space * nodeIndex;

      var deltaAngle = direction === 1 ? angleThreshold / 2 : -angleThreshold / 2;

      // 弧线是大于还是小于180度, 0-小角度弧, 1-大角度弧
      var largeArcFlag = angle - deltaAngle * 2 > 180 ? 1 : 0;

      var arc = 'A ' + radius + ' ' + radius + ' 0 ' + largeArcFlag + (direction + ' ' + projection(to.x - deltaAngle, radius));

      // 两端为二次贝塞尔曲线
      // 中间部分为圆弧
      return 'M' + projection(from.x, from.y) + ('Q' + projection(from.x, radius) + ' ') + ('' + projection(from.x + deltaAngle, radius)) + arc + ('Q' + projection(to.x, radius) + ' ') + ('' + projection(to.x, to.y));
    };

    var link = links.append('path').attr('class', 'link ' + className).attr('d', getPath);
  }
  ...
  function activeNode(target, className) {
    // 获取当前节点关联的其他 node 数据
    var relatedNode = {};
    findRelatedNode(relatedNode, target.__data__, target.__data__.data.type);
    ...
    d3.selectAll('.link').each(function (d) {
      ...
      if (relatedNode[from.data.id] && relatedNode[to.data.id]) {
    ...
    d3.selectAll('.node').each(function (d) {
      if (relatedNode[d.data.id]) {
        d3.select(this).classed(className, true).select('circle').attr('filter', 'url(#point-shadow)');
      }
    });
    ...
    // target node 绘制圆环
    d3.select(target).classed(className + '-target', true).append('circle').classed(className, true).attr('r', 12);
  }
  ...
  function inactiveNode(target, className) {
    d3.selectAll('.node.' + className).classed(className, false).select('circle').attr('filter', null);

    d3.selectAll('.link.' + className).classed(className, false);

    // remove target node 圆环
    d3.selectAll('.' + className + '-target').classed(className + '-target', false).selectAll('circle.' + className).remove();
  }
  ...
  function findRelatedNode(relatedNodes, target, moduleType) {
    ...
    if (target.children) {
      target.children.map(function (item) {
        ...
        if (!relatedNodes[item.parent.data.id]) {
          ...
          if (item.children || item.parent && item.parent.depth !== 0 && moduleType !== moduleTypes.SCENCE) {
    ...
    // 获取当前节点的间接父节点数据
    var __parent__ = target.__parent__;
    if (__parent__ && moduleType === target.data.type) {
      __parent__.map(function (item) {
  ...
  function showToolTip(node) {
    node.on('mouseenter.tooltip', function (d) {
      if (!d) {
        return;
      }
      ...
      // 构造 tooltip ui
      var container = toolTip.append('div').classed('container', true);

      container.append('h3').text(d.data.name);

      ['\u540D\u79F0\uFF1A' + d.data.name, 'id\uFF1A' + d.data.id, '\u7C7B\u578B\uFF1A' + d.data.type].map(function (text) {
        return container.append('p').text(text);
      });
  ...
  function getNodes(selection, data, className) {
    return selection.selectAll(className).data(data);
  }
    ...
    if (data.children.length) {
      data.children.map(function (item) {
        item.children.map(function (item, index) {
          var node = findNodeById(root, item.data);
          if (node) {
            // 计算 node 索引
            var moduleType = node.data.type || node.parent.data.type;
            if (node.__parent__) {
              node.__parent__.push(item.parent);
              node.data.index[item.parent.data.id] = linkTotal[moduleType]++;
            } else {
              node.__parent__ = [item.parent];
              node.data.index = _defineProperty({}, item.parent.data.id, linkTotal[moduleType]++);
            }
  ...
  function findNodeById(root, id) {
    ...
    try {
      for (var _iterator3 = Object.entries(root)[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
        var _step3$value = _slicedToArray(_step3.value, 2),
            key = _step3$value[0],
            value = _step3$value[1];

        // 数据扁平化
        var flatList = value.descendants();
        for (var i = 0, n = flatList.length; i < n; i++) {
          var item = flatList[i];
          if (_typeof(item.data) === 'object' && item.data.id === id) {
            return item;
          }
        }
      }
  ...
  function setRoot() {
    ...
    try {
      for (var _iterator4 = Object.entries(data)[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
        ...
        // 数据分层布局
        var childRoot = d3.hierarchy(data[key]);
        // 运行簇布局
  ...
  function zoom(selection, group) {
    var d3Zoom = d3.zoom().scaleExtent([0.5, 4])
    // TODO 有问题, 需进一步研究
    // .translateExtent([[0, 0], [width + rx, height + ry]])
    .on('zoom.svg', function () {
    ...
    var transform = function transform() {
      return d3.zoomIdentity.translate(rx, ry);
    };

    var transition = function transition(selection) {
      selection.transition().delay(500).duration(5000).call(d3Zoom.transform, transform).on('end.svg', function () {
        selection.call(transition);
      });
    };

    selection.call(d3Zoom).call(d3Zoom.transform, transform);
    // .call(transition);
  }
  ...
  function click(selection) {
    // 移除 node 激活态
    selection.on('click.svg', function () {
  ...
  function map(selector) {
    ...
    var svg = d3.select(selector).append('svg').attr('width', width).attr('height', height).call((0, _defs.svgDefs)());

    var g = svg.append('g').attr('transform', 'translate(' + rx + ', ' + ry + ')');
...
function svgDefs(context) {
  function drawDefs(selection) {
    ...
    // point 阴影 filter
    var filter = defs.append('filter').attr('id', 'point-shadow').attr('x', '-40%').attr('y', '-40%').attr('width', '180%').attr('height', '180%').attr('filterUnits', 'userSpaceOnUse');

    filter.append('feGaussianBlur').attr('result', 'blur2').attr('in', 'SourceGraphic').attr('stdDeviation', 5);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/_css-loader@0.28.11@css-loader/index.js!../../../node_modules/_less-loader@4.1.0@less-loader/dist/cjs.js!./monitorMap.less", function() {
			var newContent = require("!!../../../node_modules/_css-loader@0.28.11@css-loader/index.js!../../../node_modules/_less-loader@4.1.0@less-loader/dist/cjs.js!./monitorMap.less");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// module
exports.push([module.i, "svg {\n  margin: auto;\n}\npath.arc {\n  fill: #111;\n}\npath.arc2 {\n  fill: #111;\n}\npath.arc3 {\n  fill: #111;\n}\n.node {\n  fill: #D8D8D8;\n}\n.node text {\n  font-size: 13px;\n}\n.node.active,\n.node.hover {\n  fill: #07CEED;\n}\n.node.active.model.hover-target,\n.node.hover.model.hover-target,\n.node.active.model.active-target,\n.node.hover.model.active-target {\n  fill: #D0021B;\n}\n.node.active.model.hover-target circle.active,\n.node.hover.model.hover-target circle.active,\n.node.active.model.active-target circle.active,\n.node.hover.model.active-target circle.active,\n.node.active.model.hover-target circle.hover,\n.node.hover.model.hover-target circle.hover,\n.node.active.model.active-target circle.hover,\n.node.hover.model.active-target circle.hover {\n  stroke: #D0021B;\n}\n.node.active circle.active,\n.node.hover circle.active,\n.node.active circle.hover,\n.node.hover circle.hover {\n  fill: none;\n  stroke: #07CEED;\n  stroke-width: 1px;\n}\n.link {\n  fill: none;\n  stroke: #333;\n  stroke-width: 1px;\n}\n.link.active,\n.link.hover {\n  stroke: #07CEED;\n  stroke-width: 2px;\n}\n#tooltipContainer {\n  color: #D8D8D8;\n  font-family: simsun;\n  font-size: 14px;\n  padding: 10px;\n  position: absolute;\n  text-align: left;\n  border: 1px solid #333333;\n  background-color: rgba(0, 0, 0, 0.5);\n  border-radius: 5px;\n  cursor: pointer;\n}\n#tooltipContainer h3 {\n  font-size: 14px;\n  margin: 0;\n}\n#tooltipContainer p {\n  font-size: 12px;\n  margin: 5px 0px;\n}\n#tooltipContainer:hover {\n  opacity: 1;\n}\n", ""]);
